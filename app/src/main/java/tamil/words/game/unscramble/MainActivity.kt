...
import tamil.words.game.unscramble.ui.game.GameViewModel
import tamil.words.game.unscramble.ui.game.MAX_NO_OF_WORDS
import tamil.words.game.unscramble.ui.game.datas.entries
import tamil.words.game.unscramble.ui.game.datas.entries.Companion.username
import tamil.words.game.unscramble.ui.game.levelsinfo
...
import tamil.words.game.unscramble.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        InterstitialAd.load(this,"ca-app-pub-4058144912657239/2551550023", adRequest, object : InterstitialAdLoadCallback() {
    ...
    private fun exitGame() {
        GlobalScope.launch(Dispatchers.IO) {
            if (entries.scorecompanion < viewModel.score.value!!) {
                ...
                {
                    putInt(username, entries.scorecompanion)
                    apply()
                    commit()
                }
            }
