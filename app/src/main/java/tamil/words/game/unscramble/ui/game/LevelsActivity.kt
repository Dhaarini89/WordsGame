...
import tamil.words.game.unscramble.MainActivity

import tamil.words.game.unscramble.ui.game.adapter.CustomAdapter

import tamil.words.game.unscramble.ui.game.datas.LevelsViewModel
import tamil.words.game.unscramble.ui.game.datas.entries
import tamil.words.game.unscramble.ui.game.datas.entries.Companion.counter
import tamil.words.game.unscramble.ui.game.datas.entries.Companion.datalist
...
class LevelsActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        R.id.action_share -> {
            CustomDialog(this@LevelsActivity,entries.scorecompanion, username).show()
            true
        }
        R.id.action_exit -> {
